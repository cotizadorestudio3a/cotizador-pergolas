        ...
        @foreach ($services as $service)
            <div class="group relative overflow-hidden rounded-lg transition-all duration-300 ease-in-out
                ...
                @if ($selectedService === $service->id)
                    <div class="absolute top-4 right-4 w-5 h-5 bg-primary rounded-full flex items-center justify-center shadow-sm mx-auto">
                ...
                <div class="p-6 cursor-pointer">
                    ...
                    <div class="overflow-hidden transition-all duration-300 ease-in-out cursor-pointer
                        ...
                        @if ($selectedService === $service->id)
                            <div class="pt-4 border-t border-gray-200 animate-fade-in">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <flux:radio.group wire:model="selectedColor" class="space-y-2" label="Seleccione un color">
