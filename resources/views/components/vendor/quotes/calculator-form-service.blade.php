...
<div class="min-h-screen flex flex-col">
    ...
    <div class="flex-1">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            ...
            <div
                ...
                <!-- CLIENTE -->
                <div class="mb-6">
                    <label class="block mb-2 text-sm font-medium text-gray-900">Selecciona un cliente *</label>
    ...
    <div class="sticky bottom-0 bg-white border-t border-gray-200 p-6 mt-8">
        <div class="flex justify-between items-center">
            ...
            <div class="mt-4">
                <a href="#" class="text-primary text-sm font-medium hover:text-primary/80 transition-colors">+
                    agregar
                    otro servicio</a>
            </div>
